...
import type { WaTagInput, InputEvent, Event } from "../../components/tag-input/tag-input.js";
...
delimiter-separated string for an initial value. */
  ...
  /**  */
  labels?: WaTagInput["labels"];
  /** By default, form controls are associated with the nearest containing `<form>` element. This attribute allows you
to place the form control outside of a form and associate it with the form that has this `id`. The form must be in
the same document or shadow root for this to work. */
  form?: WaTagInput["form"];
  /**  */
  validity?: WaTagInput["validity"];
  /**  */
  willValidate?: WaTagInput["willValidate"];
  /**  */
  validationMessage?: WaTagInput["validationMessage"];
  /** Override this to change where constraint validation popups are anchored. */
  validationTarget?: WaTagInput["validationTarget"];
  /**  */
  allValidators?: WaTagInput["allValidators"];
  /**  */
...
export type CustomElements = {
  ...
  /**
   * Tag inputs collect a list of short values, such as keywords, email addresses, or labels, as removable tags.
   ...
   *
   * ### **Methods:**
   *  - **focus(options: _FocusOptions_)** - Sets focus on the text box.
   ...
   * - **hint** - The hint's wrapper.
   */
  "wa-tag-input": DefineComponent<WaTagInputProps>;
