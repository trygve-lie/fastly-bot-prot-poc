...
var translation = {
  ...
  tagAdded: (tag) => `${tag} lis\xE4tty`,
  tagAlreadyAdded: (tag) => `${tag} on jo lis\xE4tty`,
  tagInputKeyboardHelp: "Poista t\xE4m\xE4 tunniste painamalla Backspace tai Delete.",
  ...
  tooFewTags: (min) => min === 1 ? "Lis\xE4\xE4 v\xE4hint\xE4\xE4n 1 tunniste" : `Lis\xE4\xE4 v\xE4hint\xE4\xE4n ${min} tunnistetta`,
  tooManyTags: (max) => max === 1 ? "Lis\xE4\xE4 enint\xE4\xE4n 1 tunniste" : `Lis\xE4\xE4 enint\xE4\xE4n ${max} tunnistetta`,
