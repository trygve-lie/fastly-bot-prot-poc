...
import type { default as WaTagInput } from "./components/tag-input/tag-input.js";
...
dropdown's `wa-select` event. */
  ...
  /** When set, selecting the item will navigate to this URL. The item remains a menu item for assistive devices, so
make sure the label describes where the link goes. Ignored when the item has a submenu. */
  "prop:href"?: WaDropdownItem["href"];
  /** Tells the browser where to open the link. Only used when `href` is present. */
  "prop:target"?: WaDropdownItem["target"];
  /** When using `href`, this attribute will map to the underlying link's `rel` attribute. */
  "prop:rel"?: WaDropdownItem["rel"];
  /** Tells the browser to download the linked file as this filename. Only used when `href` is present. */
  "prop:download"?: WaDropdownItem["download"];
  /**  */
...
tag. Also used to parse the `value` attribute, which falls back to a comma when the delimiter is empty. */
  delimiter?: WaTagInput["delimiter"];
  /** The maximum number of tags that can be added. Once reached, no more tags can be added until one is removed. */
  "max-tags"?: WaTagInput["maxTags"];
  /** The maximum number of tags that can be added. Once reached, no more tags can be added until one is removed. */
  maxTags?: WaTagInput["maxTags"];
  /** The minimum number of tags required for the control to be valid. Has no effect when there are no tags. */
  "min-tags"?: WaTagInput["minTags"];
  /** The minimum number of tags required for the control to be valid. Has no effect when there are no tags. */
  minTags?: WaTagInput["minTags"];
  /** Allows the same tag to be added more than once. By default, duplicates are ignored. */
  "allow-duplicates"?: WaTagInput["allowDuplicates"];
  /** Allows the same tag to be added more than once. By default, duplicates are ignored. */
  allowDuplicates?: WaTagInput["allowDuplicates"];
  /** Adds a clear button that removes all tags. */
  "with-clear"?: WaTagInput["withClear"];
  /** Adds a clear button that removes all tags. */
  withClear?: WaTagInput["withClear"];
  /** Placeholder text to show in the text box. Hidden once the maximum number of tags is reached. */
  placeholder?: WaTagInput["placeholder"];
  /** The tag input's label. If you need to display HTML, use the `label` slot instead. */
  label?: WaTagInput["label"];
  /** The tag input's hint. If you need to display HTML, use the `hint` slot instead. */
  hint?: WaTagInput["hint"];
  /** Only required for SSR. Set to `true` if you're slotting in a `label` element so the server-rendered markup
includes the label before the component hydrates on the client. */
  "with-label"?: WaTagInput["withLabel"];
  /** Only required for SSR. Set to `true` if you're slotting in a `label` element so the server-rendered markup
includes the label before the component hydrates on the client. */
  withLabel?: WaTagInput["withLabel"];
  /** Only required for SSR. Set to `true` if you're slotting in a `hint` element so the server-rendered markup
includes the hint before the component hydrates on the client. */
  "with-hint"?: WaTagInput["withHint"];
  /** Only required for SSR. Set to `true` if you're slotting in a `hint` element so the server-rendered markup
includes the hint before the component hydrates on the client. */
  withHint?: WaTagInput["withHint"];
  /** The tag input's size. Also applied to each tag. */
  size?: WaTagInput["size"];
  /** The tag input's visual appearance. */
  appearance?: WaTagInput["appearance"];
  /** Draws a pill-style tag input, and pill-style tags, with rounded edges. */
  pill?: WaTagInput["pill"];
  /** Makes the tag input readonly. Tags stay visible and are still submitted, but can't be added or removed. */
  readonly?: WaTagInput["readonly"];
  /** Makes the tag input a required field, so at least one tag must be added. */
  required?: WaTagInput["required"];
  /** Controls whether and how text input is automatically capitalized as it is entered by the user. */
  autocapitalize?: WaTagInput["autocapitalize"];
  /** Indicates whether the browser's autocorrect feature is on or off. When set as an attribute, use `"off"` or `"on"`.
When set as a property, use `true` or `false`. */
  autocorrect?: WaTagInput["autocorrect"];
  /** Specifies what permission the browser has to provide assistance in filling out form field values. Refer to
[this page on MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete) for available values.
Defaults to `off`. */
  autocomplete?: WaTagInput["autocomplete"];
  /** Used to customize the label or icon of the Enter key on virtual keyboards. */
  enterkeyhint?: WaTagInput["enterkeyhint"];
  /** Enables spell checking on the text box. */
  spellcheck?: WaTagInput["spellcheck"];
  /** Tells the browser what type of data will be entered by the user, allowing it to display the appropriate virtual
keyboard on supportive devices. */
  inputmode?: WaTagInput["inputmode"];
  /** The name of the input, submitted as a name/value pair with form data. */
  name?: WaTagInput["name"];
  /** Disables the form control. */
  disabled?: WaTagInput["disabled"];
  /**  */
  "custom-error"?: WaTagInput["customError"];
  /**  */
  customError?: WaTagInput["customError"];
  /**  */
  dir?: WaTagInput["dir"];
  /**  */
  lang?: WaTagInput["lang"];
  /**  */
  "did-ssr"?: WaTagInput["didSSR"];
  /**  */
  didSSR?: WaTagInput["didSSR"];
  /**  */
  assumeInteractionOn?: WaTagInput["assumeInteractionOn"];
  /**  */
  input?: WaTagInput["input"];
  /** The text currently typed in the text box that hasn't become a tag yet. */
  inputValue?: WaTagInput["inputValue"];
  /**  */
  valueHasChanged?: WaTagInput["valueHasChanged"];
  /**  */
  hasInteracted?: WaTagInput["hasInteracted"];
  /**  */
  states?: WaTagInput["states"];
  /**  */
  emitInvalid?: WaTagInput["emitInvalid"];
  /** By default, form controls are associated with the nearest containing `<form>` element. This attribute allows you
to place the form control outside of a form and associate it with the form that has this `id`. The form must be in
the same document or shadow root for this to work. */
  form?: WaTagInput["form"];
  /**  */
  initialReflectedProperties?: WaTagInput["initialReflectedProperties"];
  /**  */
  internals?: WaTagInput["internals"];
...
export type WaTagInputSolidJsProps = {
  /** The default value of the form control as a delimiter-separated string. Primarily used for resetting the form
control. */
  "attr:value"?: WaTagInput["defaultValue"];
  /** The default value of the form control as a delimiter-separated string. Primarily used for resetting the form
control. */
  "prop:defaultValue"?: WaTagInput["defaultValue"];
  /** The characters that turn typed text into a tag. Each character is a separate delimiter, so `",;"` accepts both
commas and semicolons. Pasted text is split on the same characters. Set to an empty string so only Enter adds a
tag. Also used to parse the `value` attribute, which falls back to a comma when the delimiter is empty. */
  "prop:delimiter"?: WaTagInput["delimiter"];
  /** The maximum number of tags that can be added. Once reached, no more tags can be added until one is removed. */
  "attr:max-tags"?: WaTagInput["maxTags"];
  /** The maximum number of tags that can be added. Once reached, no more tags can be added until one is removed. */
  "prop:maxTags"?: WaTagInput["maxTags"];
  /** The minimum number of tags required for the control to be valid. Has no effect when there are no tags. */
  "attr:min-tags"?: WaTagInput["minTags"];
  /** The minimum number of tags required for the control to be valid. Has no effect when there are no tags. */
  "prop:minTags"?: WaTagInput["minTags"];
  /** Allows the same tag to be added more than once. By default, duplicates are ignored. */
  "bool:allow-duplicates"?: WaTagInput["allowDuplicates"];
  /** Allows the same tag to be added more than once. By default, duplicates are ignored. */
  "prop:allowDuplicates"?: WaTagInput["allowDuplicates"];
  /** Adds a clear button that removes all tags. */
  "bool:with-clear"?: WaTagInput["withClear"];
  /** Adds a clear button that removes all tags. */
  "prop:withClear"?: WaTagInput["withClear"];
  /** Placeholder text to show in the text box. Hidden once the maximum number of tags is reached. */
  "prop:placeholder"?: WaTagInput["placeholder"];
  /** The tag input's label. If you need to display HTML, use the `label` slot instead. */
  "prop:label"?: WaTagInput["label"];
  /** The tag input's hint. If you need to display HTML, use the `hint` slot instead. */
  "prop:hint"?: WaTagInput["hint"];
  /** Only required for SSR. Set to `true` if you're slotting in a `label` element so the server-rendered markup
includes the label before the component hydrates on the client. */
  "bool:with-label"?: WaTagInput["withLabel"];
  /** Only required for SSR. Set to `true` if you're slotting in a `label` element so the server-rendered markup
includes the label before the component hydrates on the client. */
  "prop:withLabel"?: WaTagInput["withLabel"];
  /** Only required for SSR. Set to `true` if you're slotting in a `hint` element so the server-rendered markup
includes the hint before the component hydrates on the client. */
  "bool:with-hint"?: WaTagInput["withHint"];
  /** Only required for SSR. Set to `true` if you're slotting in a `hint` element so the server-rendered markup
includes the hint before the component hydrates on the client. */
  "prop:withHint"?: WaTagInput["withHint"];
  /** The tag input's size. Also applied to each tag. */
  "prop:size"?: WaTagInput["size"];
  /** The tag input's visual appearance. */
  "prop:appearance"?: WaTagInput["appearance"];
  /** Draws a pill-style tag input, and pill-style tags, with rounded edges. */
  "prop:pill"?: WaTagInput["pill"];
  /** Makes the tag input readonly. Tags stay visible and are still submitted, but can't be added or removed. */
  "prop:readonly"?: WaTagInput["readonly"];
  /** Makes the tag input a required field, so at least one tag must be added. */
  "prop:required"?: WaTagInput["required"];
  /** Controls whether and how text input is automatically capitalized as it is entered by the user. */
  "prop:autocapitalize"?: WaTagInput["autocapitalize"];
  /** Indicates whether the browser's autocorrect feature is on or off. When set as an attribute, use `"off"` or `"on"`.
When set as a property, use `true` or `false`. */
  "prop:autocorrect"?: WaTagInput["autocorrect"];
  /** Specifies what permission the browser has to provide assistance in filling out form field values. Refer to
[this page on MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete) for available values.
Defaults to `off`. */
  "prop:autocomplete"?: WaTagInput["autocomplete"];
  /** Used to customize the label or icon of the Enter key on virtual keyboards. */
  "prop:enterkeyhint"?: WaTagInput["enterkeyhint"];
  /** Enables spell checking on the text box. */
  "prop:spellcheck"?: WaTagInput["spellcheck"];
  /** Tells the browser what type of data will be entered by the user, allowing it to display the appropriate virtual
keyboard on supportive devices. */
  "prop:inputmode"?: WaTagInput["inputmode"];
  /** The name of the input, submitted as a name/value pair with form data. */
  "prop:name"?: WaTagInput["name"];
  /** Disables the form control. */
  "prop:disabled"?: WaTagInput["disabled"];
  /**  */
  "attr:custom-error"?: WaTagInput["customError"];
  /**  */
  "prop:customError"?: WaTagInput["customError"];
  /**  */
  "prop:dir"?: WaTagInput["dir"];
  /**  */
  "prop:lang"?: WaTagInput["lang"];
  /**  */
  "attr:did-ssr"?: WaTagInput["didSSR"];
  /**  */
  "prop:didSSR"?: WaTagInput["didSSR"];
  /**  */
  "prop:assumeInteractionOn"?: WaTagInput["assumeInteractionOn"];
  /**  */
  "prop:input"?: WaTagInput["input"];
  /** The text currently typed in the text box that hasn't become a tag yet. */
  "prop:inputValue"?: WaTagInput["inputValue"];
  /**  */
  "prop:valueHasChanged"?: WaTagInput["valueHasChanged"];
  /**  */
  "prop:hasInteracted"?: WaTagInput["hasInteracted"];
  /**  */
  "prop:states"?: WaTagInput["states"];
  /**  */
  "prop:emitInvalid"?: WaTagInput["emitInvalid"];
  /** By default, form controls are associated with the nearest containing `<form>` element. This attribute allows you
to place the form control outside of a form and associate it with the form that has this `id`. The form must be in
the same document or shadow root for this to work. */
  "prop:form"?: WaTagInput["form"];
  /**  */
  "prop:initialReflectedProperties"?: WaTagInput["initialReflectedProperties"];
  /**  */
  "prop:internals"?: WaTagInput["internals"];
  /** Emitted when the user types in the text box or when a tag is added or removed. */
  "on:input"?: (e: InputEvent) => void;
  /** Emitted when a tag is added, removed, or all tags are cleared by the user. */
  "on:change"?: (e: Event) => void;
...
export type CustomElements = {
   ...
   * - `href`: When set, selecting the item will navigate to this URL. The item remains a menu item for assistive devices, so
   * make sure the label describes where the link goes. Ignored when the item has a submenu.
   * - `target`: Tells the browser where to open the link. Only used when `href` is present.
   * - `rel`: When using `href`, this attribute will map to the underlying link's `rel` attribute.
   * - `download`: Tells the browser to download the linked file as this filename. Only used when `href` is present.
   ...
   * These can be used to apply styling when a component is in a given state.
   *
   * - `active`: Applied when the item is the active item in the menu.
   * - `checked`: Applied when the item is checked.
   * - `disabled`: Applied when the item is disabled.
   * - `has-submenu`: Applied when the item has a submenu.
   * - `link`: Applied when the item is a link (i.e. `href` is set).
   * - `submenu-open`: Applied when the item's submenu is open.
   */
   ...
   * Component attributes and properties that can be applied to the element or by using JavaScript.
   *
   * - `value`/`defaultValue`: The default value of the form control as a delimiter-separated string. Primarily used for resetting the form
   * control.
   * - `delimiter`: The characters that turn typed text into a tag. Each character is a separate delimiter, so `",;"` accepts both
   * commas and semicolons. Pasted text is split on the same characters. Set to an empty string so only Enter adds a
   * tag. Also used to parse the `value` attribute, which falls back to a comma when the delimiter is empty.
   * - `max-tags`/`maxTags`: The maximum number of tags that can be added. Once reached, no more tags can be added until one is removed.
   * - `min-tags`/`minTags`: The minimum number of tags required for the control to be valid. Has no effect when there are no tags.
   * - `allow-duplicates`/`allowDuplicates`: Allows the same tag to be added more than once. By default, duplicates are ignored.
   * - `with-clear`/`withClear`: Adds a clear button that removes all tags.
   * - `placeholder`: Placeholder text to show in the text box. Hidden once the maximum number of tags is reached.
   * - `label`: The tag input's label. If you need to display HTML, use the `label` slot instead.
   * - `hint`: The tag input's hint. If you need to display HTML, use the `hint` slot instead.
   * - `with-label`/`withLabel`: Only required for SSR. Set to `true` if you're slotting in a `label` element so the server-rendered markup
   * includes the label before the component hydrates on the client.
   * - `with-hint`/`withHint`: Only required for SSR. Set to `true` if you're slotting in a `hint` element so the server-rendered markup
   * includes the hint before the component hydrates on the client.
   * - `size`: The tag input's size. Also applied to each tag.
   * - `appearance`: The tag input's visual appearance.
   * - `pill`: Draws a pill-style tag input, and pill-style tags, with rounded edges.
   * - `readonly`: Makes the tag input readonly. Tags stay visible and are still submitted, but can't be added or removed.
   * - `required`: Makes the tag input a required field, so at least one tag must be added.
   * - `autocapitalize`: Controls whether and how text input is automatically capitalized as it is entered by the user.
   * - `autocorrect`: Indicates whether the browser's autocorrect feature is on or off. When set as an attribute, use `"off"` or `"on"`.
   * When set as a property, use `true` or `false`.
   * - `autocomplete`: Specifies what permission the browser has to provide assistance in filling out form field values. Refer to
   ...
   * Defaults to `off`.
   * - `enterkeyhint`: Used to customize the label or icon of the Enter key on virtual keyboards.
   * - `spellcheck`: Enables spell checking on the text box.
   * - `inputmode`: Tells the browser what type of data will be entered by the user, allowing it to display the appropriate virtual
   * keyboard on supportive devices.
   * - `name`: The name of the input, submitted as a name/value pair with form data.
   * - `disabled`: Disables the form control.
   ...
   * - `assumeInteractionOn`: undefined (property only)
   * - `input`: undefined (property only)
   * - `value`: The tags as an array of strings, submitted as one entry per tag under `name`. Set the `value` attribute to a
   * delimiter-separated string for an initial value. (property only)
   * - `inputValue`: The text currently typed in the text box that hasn't become a tag yet. (property only)
   * - `valueHasChanged`: undefined (property only)
   * - `hasInteracted`: undefined (property only)
   * - `states`: undefined (property only)
   * - `emitInvalid`: undefined (property only)
   ...
   * - `handleSizeChange() => void`: undefined
   * - `formResetCallback() => void`: undefined
   * - `focus(options?: FocusOptions) => void`: Sets focus on the text box.
   * - `blur() => void`: Removes focus from the text box.
   * - `getForm() => void`: undefined
   * - `checkValidity() => void`: undefined
   * - `reportValidity() => void`: undefined
   * - `setValidity(args: Parameters<typeof this.internals.setValidity>) => void`: undefined
   ...
   *
   * - `form-control-label`: The label.
   * - `tag-input`: The component's outer wrapper, the bordered box that holds the tags and text box.
   * - `start`: The container that wraps the `start` slot.
   * - `tags`: The list that holds the tags.
   * - `tag`: Each tag, a `<wa-tag>`.
   * - `tag__content`: The tag's content part.
   * - `tag__remove-button`: The tag's remove button.
   * - `tag__remove-button__base`: The tag's remove button base part.
   * - `input`: The internal text box, an `<input>` element.
   * - `clear-button`: The clear button.
   * - `end`: The container that wraps the `end` slot.
   * - `hint`: The hint's wrapper.
   *
   ...
   * These can be used to apply styling when a component is in a given state.
   *
   * - `blank`: The tag input has no tags.
   * - `readonly`: The tag input is readonly.
   */
  "wa-tag-input": Partial<WaTagInputProps & BaseProps<WaTagInput> & BaseEvents>;
...
export type CustomElementsSolidJs = {
   ...
   * - `readonly`: The tag input is readonly.
   */
  "wa-tag-input": Partial<
    WaTagInputProps &
      WaTagInputSolidJsProps &
      BaseProps<WaTagInput> &
      BaseEvents
  >;
